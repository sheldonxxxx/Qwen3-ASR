    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        cache_position (`torch.LongTensor` of shape `(sequence_length)`, *optional*):
            Indices describing where the current input tokens should be written in the cache. When not provided,
            the positions are inferred from the current cache state during the prefill pass.
        """
    ...
    def forward(
        ...
        **kwargs,
        ...
        rope_deltas (`torch.LongTensor` of shape `(batch_size, )`, *optional*):
            The rope index difference between sequence length and multimodal rope.
        cache_position (`torch.LongTensor` of shape `(sequence_length)`, *optional*):
            Indices describing where the current decoder tokens should be written in the cache. During the initial
            prefill call this can be `None`, in which case the positions are inferred from the current sequence.
